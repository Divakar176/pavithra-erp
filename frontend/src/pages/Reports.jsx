        ...
        <div className="p-6">
            <div className="flex justify-between items-center mb-8">
                ...
                <button
                    ...
                    className="flex items-center space-x-2 bg-[#10B981] hover:bg-[#059669] text-white px-6 py-3 rounded-xl transition-colors font-medium shadow-lg shadow-[#10B981]/20"
                >
                    <Download size={20} />
            ...
            <div className="bg-[#1A1A1A] p-6 rounded-2xl border border-[#2A2A2A] mb-8">
                <div className="flex items-center space-x-4 mb-6">
                    ...
                    <select 
                        ...
                        className="bg-[#222222] text-white border border-[#333] px-4 py-2 rounded-lg focus:outline-none focus:border-[#D8621C]"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#222222] border border-[#333] p-6 rounded-xl">
                        ...
                        <h3 className="text-3xl font-bold text-white">₹{kpis?.totalRevenue?.toLocaleString() || 0}</h3>
                    </div>
                    ...
                    <div className="bg-[#222222] border border-[#333] p-6 rounded-xl ring-1 ring-[#D8621C]/50 relative overflow-hidden">
                        ...
                        <h3 className="text-4xl font-black text-white relative z-10">₹{kpis?.netProfit?.toLocaleString() || 0}</h3>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#1A1A1A] p-6 rounded-2xl border border-[#2A2A2A]">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-[#222222] rounded-xl border border-[#333]">
                            <div>
                                <h4 className="text-white font-medium">Profit & Loss Statement</h4>
                                <p className="text-sm text-gray-500">Summary of all income and expenses</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-[#222222] rounded-xl border border-[#333] opacity-50">
                            <div>
                                <h4 className="text-white font-medium">Driver Performance Report</h4>
                                <p className="text-sm text-gray-500">Detailed stats on driver trips (Coming Soon)</p>
                            </div>
                ...
                <div className="bg-[#1A1A1A] p-6 rounded-2xl border border-[#2A2A2A]">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-[#222222] rounded-xl border border-[#333] opacity-50">
                            <div>
                                <h4 className="text-white font-medium">Fleet Maintenance Logs</h4>
                                <p className="text-sm text-gray-500">Summary of recent services (Coming Soon)</p>
                            </div>
                            <button disabled className="p-2 text-[#A0A0A0]">
                                <Download size={20} />
                            </button>
